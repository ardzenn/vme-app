document.addEventListener('DOMContentLoaded', () => {
    ...
    orderDetailModalEl.addEventListener('shown.bs.modal', function (event) {
        ...
        // --- START: ROLE-SPECIFIC LOGIC ---
        // This section decides what to show in the main invoice area based on user role.
        if (currentUser.role === 'Accounting' || currentUser.role === 'Admin') {
            ...
            // For all OTHER users, build the READ-ONLY view.
        ...
        // --- START: SHARED LOGIC FOR ALL USERS (ATTACHMENTS & CHAT) ---
        // This part now runs for everyone, regardless of role.
        if (order.attachment) {
